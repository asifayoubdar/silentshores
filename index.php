            ...
            <div class="header__contents">
                ...
                <nav class="main-nav">
                    <ul class="main-nav__list">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-item__link">Destinations</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-item__link">Services</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="cta-box">
                    <button class="btn btn--pri btn--cta">Book Now</button>
                </div>
            </div>
        </div>
    </header>
                    ...
                    <div class="main-banner-contents">
                        <div class="text-side">
                            ...
                            <div class="main-section__cta">
                                <button class="btn btn--pri btn--lg btn--cta">Book your kashmir adventure now!</button>
                            </div>
                        </div>
                        <div class="img-side">
                ...
                <div class="cards container-sm">
                    <div class="card">
                        <div class="card__img-box">
                            <img src="./assets/images/des-11.jpg" alt="">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">
                                Srinagar
                            ...
                            <a href="#" class="card-action btn btn--sm btn--pri">View Details</a>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="card__img-box">
                            <img src="./assets/images/gulmarg.jpg" alt="">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">
                                Gulmarg
                    ...
                    <div class="card">
                        <div class="card__img-box">
                            <img src="./assets/images/des-31.jpg" alt="">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">
                                Sonmarg
                    ...
                    <div class="card">
                        <div class="card__img-box">
                            <img src="./assets/images/des-41.jpg" alt="">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">
                                Doodhpathri
                ...
                <div class="contact-content">
                    <div class="text-side">
                        ...
                        <div class="contact-call">
                            <h4>For any enquiry, call us +91 7889824280</h4>
                        </div>
                    </div>
                    <div class="form-side">
                        <form id="contact-form" class="form-contents" action="./email.php" method="POST">
                            ...
                            <div class="contact-row row--2">
                                <div class="input-group">
                                    <input type="text" name="email" placeholder="Email Id (optional)">
                                </div>
                                <div class="input-group">
                                    <input type="date" name="date" placeholder="Date of arrival">
                                </div>
                            </div>
                            <div class="contact-row">
                                <div class="input-group">
                                    <textarea name="desc" id="" placeholder="Message"></textarea>
                                </div>
                            </div>
                            <div class="form-action">
                                <button class="btn btn--pri btn--frm-action">Send</button>
                            </div>
                        </form>
                    </div>
                </div>
